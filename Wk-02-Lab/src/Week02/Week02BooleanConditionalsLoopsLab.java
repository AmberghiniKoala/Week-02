...
int cookiesForMe = numberOfCookies % numberOfChildren;

if (cookiesForMe == 0) {
	System.out.println("Sad Face");
} else if (cookiesForMe < 2) {
	System.out.println("Yes!");
} else if (cookiesForMe < 5) {
	System.out.println("Whoohoooo!");
} else {System.out.println("Jackpot!");
}
...
if (adjustedTotal > 500.00) {
	...
	} else {loyaltyMemberStatus = "SILVER";
	}	
